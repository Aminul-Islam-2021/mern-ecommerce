...
const CateDrawer = ({ isOpen, onClose }) => {
        ...
        <div className="p-4">
          {categories.map((category, index) => (
            <div key={index} className="mb-4">
              <div
                className="flex justify-between items-center font-medium text-gray-800 cursor-pointer"
                onClick={() =>{ toggleCategory(index);handleCategoryClick();}}
              >
                {category.name}
